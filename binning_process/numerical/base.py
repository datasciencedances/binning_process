"""
NumericalBaseBinner: base class cho mọi Binner numerical (supervised/unsupervised).
...
from binning_process.numerical.merge_process import MergeTrace, enforce_monotonic_traced
...
class NumericalBaseBinner(BaseEstimator, TransformerMixin):
    """
    Base class cho binning biến số: preprocessing, fit/transform/summary/plot.
